...
Got-Z is a graph database project for durable, queryable agent memory. The intended role is a second brain for AI agent harnesses: a structured alternative to Obsidian-style note graphs, optimized for relationships, retrieval, and long-running context.
